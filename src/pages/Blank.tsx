      ...
      <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-7 xl:px-10 xl:py-12 dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="mx-auto w-full max-w-[630px] text-center">
          ...
          <p className="text-sm text-gray-500 sm:text-base dark:text-gray-400">
            Empiece a colocar contenido en cuadrículas o paneles; también puede usar diferentes combinaciones de
            cuadrículas. Consulte el panel de control y otras páginas.
          </p>
        </div>
      </div>
    </div>
