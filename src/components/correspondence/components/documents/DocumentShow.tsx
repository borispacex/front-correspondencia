        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-white/[0.05] dark:bg-white/[0.03]">
            ...
            <div className="mt-6 flex gap-2 border-t border-gray-200 pt-5 dark:border-white/[0.05]">
                {Array.from({ length: 3 }).map((_, i) => (
                    <div
                        key={i}
                        className="h-9 flex-1 animate-pulse rounded-lg bg-gray-200 dark:bg-white/[0.08]"
                    />
                ))}
            </div>
        </div>
    ...
    return (
        <div className={selectedCardClasses}>
            ...
            <div className="relative">
                ...
                <div className="absolute bottom-10 left-5 top-10 w-px bg-gray-200 dark:bg-white/[0.08]" />
            ...
            <div className="mt-6 flex gap-2 border-t border-gray-200 pt-5 dark:border-white/[0.05]">
                ...
                {(["Resend", "Forward", "Preview"] as const).map(
                    (label) => (
                        <button
                            key={label}
