...
import { PendingFilters, PendingSortConfig } from '../../../hooks/filters/usePendingFilters.ts';
...
export const PendingFilter = ({ filters, sort, onFiltersChange, onSortChange, onReset }: Props) => {
