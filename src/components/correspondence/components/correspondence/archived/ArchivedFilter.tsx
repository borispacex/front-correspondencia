...
import { ArchivedFilters, ArchivedSortConfig } from '../../../hooks/filters/useArchivedFilters.ts';
...
export const ArchivedFilter = ({ filters, sort, onFiltersChange, onSortChange, onReset }: Props) => {
