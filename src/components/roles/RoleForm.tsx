...
import type { Role, CreateRoleRequest } from '../../types/admin/roles/role.types';
      ...
      <div>
        ...
        <div className="mt-2 rounded-lg border border-gray-200 dark:border-gray-700">
          {groupLoading ? (
            ...
            <div className="px-5 py-10 text-center text-sm text-gray-400">No hay permisos registrados</div>
          ) : (
            <div>
                ...
                return (
                  <div key={group} className="border-b border-gray-100 last:border-0 dark:border-gray-700/50">
                    <button
                      ...
                      className="flex w-full items-center gap-2 bg-gray-50 px-4 py-2 text-left text-xs font-semibold tracking-wide text-gray-600 uppercase hover:bg-gray-100 dark:bg-white/[0.02] dark:text-gray-400 dark:hover:bg-white/[0.04]"
                    >
                      <Checkbox
                        checked={allChecked}
                        onChange={() => toggleGroup(perms)}
                        className={
                          !allChecked && someChecked ? 'border-brand-400 bg-brand-200 dark:bg-brand-500/30' : ''
                        }
                      />
