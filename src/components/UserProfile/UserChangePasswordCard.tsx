    ...
    <>
      <div className="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h4 className="text-lg font-semibold text-gray-800 lg:mb-6 dark:text-white/90">Seguridad</h4>

            <div className="grid grid-cols-2 gap-4 lg:grid-cols-4 lg:gap-7 2xl:gap-x-32">
              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Contraseña</p>
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">{'*********'}</p>
              </div>

              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Ultimo cambio contraseña</p>
              ...
              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Fecha de actualiación</p>
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
              ...
              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Fecha de creación</p>
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">{formatDateBo(user?.created_at)}</p>
              </div>
            </div>
          </div>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} className="max-w-md p-6 sm:p-8">
        <div>
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">Cambiar contraseña</h3>
