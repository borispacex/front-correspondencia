    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
        <div className="col-span-2 lg:col-span-1">
          <Label>
            ...
            <Tooltip
              content={
                <div>
                  <p className="mb-2 font-medium">La contraseña debe contener:</p>
            ...
            <span className="ml-1 text-xs text-gray-400">
              (Recomendamos una contraseña segura)<span className="text-error-500"> *</span>
            </span>
          </Label>
          <InputFieldPassword
            value={password}
        ...
        <div className="col-span-2 lg:col-span-1">
          <Label>
            ...
            <br />
            <span className="ml-1 text-xs text-gray-400">
              (Las contraseñas deben coincidir)<span className="text-error-500"> *</span>
            </span>
          </Label>
          <InputFieldPassword
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
        <div className="col-span-2 lg:col-span-1">
          ...
          <InputField type="text" value={formatDateBo(user?.UltimoCambioContrasenia ?? user?.created_at)} disabled />
        </div>
      </div>
