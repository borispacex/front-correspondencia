...
import { BellIcon, CheckCircleIcon, AlertIcon, CloseIcon, InfoIcon, TrashBinIcon } from '../../icons';
  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="shadow-theme-lg dark:bg-gray-dark absolute right-0 z-[9999] mt-2 flex h-[50vh] w-[calc(100vw-16px)] max-w-[380px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:h-[480px] sm:w-[360px] dark:border-gray-800"
      >
        ...
        <div className="mb-3 flex items-center justify-between gap-2">
          <button
            ...
            className="hover:text-brand-500 dark:hover:text-brand-400 text-xs font-medium text-gray-600 hover:underline dark:text-gray-400"
          >
          ...
          <button
            ...
            className="hover:text-error-500 dark:hover:text-error-400 text-xs font-medium text-gray-600 hover:underline dark:text-gray-400"
          >
            <TrashBinIcon />
          </button>
        </div>
