  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 dark:bg-[#0f172a]">
        <img src="/images/logo_emi/emi_icono.png" className="h-20 w-auto animate-pulse" alt="logo_emi" />

        <p className="mt-5 text-sm text-gray-500 dark:text-gray-400">Cargando...</p>
