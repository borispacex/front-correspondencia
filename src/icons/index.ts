...
import { ReactComponent as HouseIcon } from './house.svg?react';
import { ReactComponent as UserIcon } from './user.svg?react';
import { ReactComponent as UserCogIcon } from './user-cog.svg?react';
import { ReactComponent as UsersIcon } from './users.svg?react';
import { ReactComponent as FileTextIcon } from './file-text.svg?react';
import { ReactComponent as FingerprintPatternIcon } from './fingerprint-pattern.svg?react';
import { ReactComponent as LogOutIcon } from './log-out.svg?react';
import { ReactComponent as LogInIcon } from './log-in.svg?react';
import { ReactComponent as CameraIcon } from './camera.svg?react';
import { ReactComponent as CiudadaniaDigitalIcon } from './ciudadania-digital.svg?react';
import { ReactComponent as MicrosoftIcon } from './microsoft.svg?react';
import { ReactComponent as Office365Icon } from './office-365.svg?react';
import { ReactComponent as LockOpenIcon } from './lock-open.svg?react';
